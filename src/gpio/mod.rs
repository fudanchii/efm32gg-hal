...
gpio!(
    ...
    [
    PA0:  (pa0,   0, pa_din, pa_dout,  mode0, pa_model, pa_doutclr, pa_doutset, pa_douttgl),
    PB7:  (pb7,   7, pb_din, pb_dout,  mode7, pb_model, pb_doutclr, pb_doutset, pb_douttgl),
    PB8:  (pb8,   8, pb_din, pb_dout,  mode8, pb_modeh, pb_doutclr, pb_doutset, pb_douttgl),
    PB11: (pb11, 11, pb_din, pb_dout, mode11, pb_modeh, pb_doutclr, pb_doutset, pb_douttgl),
    PB13: (pb13, 13, pb_din, pb_dout, mode13, pb_modeh, pb_doutclr, pb_doutset, pb_douttgl),
    PB14: (pb14, 14, pb_din, pb_dout, mode14, pb_modeh, pb_doutclr, pb_doutset, pb_douttgl),
    PC0:  (pc0,   0, pc_din, pc_dout,  mode0, pc_model, pc_doutclr, pc_doutset, pc_douttgl),
    PC1:  (pc1,   1, pc_din, pc_dout,  mode1, pc_model, pc_doutclr, pc_doutset, pc_douttgl),
    PC14: (pc14, 14, pc_din, pc_dout, mode14, pc_modeh, pc_doutclr, pc_doutset, pc_douttgl),
    PC15: (pc15, 15, pc_din, pc_dout, mode15, pc_modeh, pc_doutclr, pc_doutset, pc_douttgl),
    PE12: (pe12, 12, pe_din, pe_dout, mode12, pe_modeh, pe_doutclr, pe_doutset, pe_douttgl),
    PE13: (pe13, 13, pe_din, pe_dout, mode13, pe_modeh, pe_doutclr, pe_doutset, pe_douttgl),
    PF0:  (pf0,   0, pf_din, pf_dout,  mode0, pf_model, pf_doutclr, pf_doutset, pf_douttgl),
    PF1:  (pf1,   1, pf_din, pf_dout,  mode1, pf_model, pf_doutclr, pf_doutset, pf_douttgl),
    PF2:  (pf2,   2, pf_din, pf_dout,  mode2, pf_model, pf_doutclr, pf_doutset, pf_douttgl),
]);
